...
Ext.define('Ext.view.TableLayout', {
    ...
    beginLayout: function (ownerContext) {
        ...
        ownerContext.doSyncRowHeights = partner && partner.grid.isVisible() && (owner.ownerGrid.syncRowHeight || owner.hasVariableRowHeight());
    ...
    calculate: function (ownerContext) {
        ...
        if (lockingPartnerContext && ownerContext.doSyncRowHeights) {
